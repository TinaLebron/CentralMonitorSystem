namespace CentralＭonitoringSystem.src.views
{
    partial class BuildingTableUserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.groupBoxPoints.Controls.Add(this.radioButton26);
            this.groupBoxPoints.Controls.Add(this.radioButton25);
            this.groupBoxPoints.Controls.Add(this.radioButton24);
            this.groupBoxPoints.Controls.Add(this.radioButton23);
            this.groupBoxPoints.Controls.Add(this.radioButton22);
            this.groupBoxPoints.Controls.Add(this.radioButton21);
            this.groupBoxPoints.Controls.Add(this.radioButton20);
            this.groupBoxPoints.Controls.Add(this.radioButton19);
            this.groupBoxPoints.Controls.Add(this.radioButton18);
            this.groupBoxPoints.Controls.Add(this.radioButton17);
            this.groupBoxPoints.Controls.Add(this.radioButton16);
            this.groupBoxPoints.Controls.Add(this.radioButton15);
            this.groupBoxPoints.Controls.Add(this.radioButton14);
